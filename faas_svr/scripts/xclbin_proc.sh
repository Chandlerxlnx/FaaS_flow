...
xclbinutil --dump-section BITSTREAM:RAW:kernal.dcp --input $xcl_file
...
then
  ...
  then
     ...
     xclbinutil --add-section BITSTREAM:RAW:$partial_bit --input $1_dummy.xclbin --output $1_bit.xclbin
  else
